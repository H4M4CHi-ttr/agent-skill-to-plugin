...
Configured limits at version 0.6.1 are 5,000 entries, 100 MiB per member, 512 MiB total expanded data, 100 MiB downloaded or compressed data, 20 path levels, and 1,024 path characters. The generated ZIP has one top-level Plugin directory and deterministic member metadata.
